...
def strike_ladders(expiries, percent_ladders, fwd, test_params, generator, model,
                   transform='ShiftedBlackScholes'):
    """ Calculate volatilities along ladders of strikes """
    is_call = generator.is_call

    # Calculate prices
    rf_prc, md_prc, strikes, sprds = generator.price_strike_ladder(model, expiries, percent_ladders,
                                                                   fwd, test_params)

    # Invert to tranform vols
    rf_nvols = []
    md_nvols = []
