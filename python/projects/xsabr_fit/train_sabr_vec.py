...
# Set ANN's topology
def set_sabr_model_vec(n_features):
    model = Sequential()
...
def train_sabr_model_vec(out_model_file, model=None):
    ...
    if model is None:
        model = set_sabr_model_vec(nFeatures)
...
train_sabr_model_vec(model_file, init_model)
