...
def convert_name_ordering(name):
    ...
    new_name = name[3:6] + name[0:3] + ' Curncy'
    return new_name
...
def read_all_fx_data(xls_file_name):
    ...
    print(f'Data is up to date at: {time.ctime(os.path.getmtime(xls_file_name))}')
