...
# ToDo
def convert_target(target: OptionTarget, target_type: OptionQuoteType, shift: float) -> OptionTarget:
    """ Convert option target from its type to the chosen target type """
    raise NotImplementedError("Not implemented yet: convert_target")
