...
CCY_CALENDARS = {
        ...
        "CHF": lambda y: holidays.CN(years=y), # TODO
        "CLP": lambda y: holidays.CN(years=y), # TODO
        "CNY": lambda y: holidays.CN(years=y),
        "COP": lambda y: holidays.CN(years=y), # TODO
        "CZK": lambda y: holidays.CN(years=y), # TODO
        "DKK": lambda y: holidays.CN(years=y), # TODO
        "EGP": lambda y: holidays.CN(years=y), # TODO
        "EUR": lambda y: holidays.ECB(years=y), # TARGET calendar
        "GBP": lambda y: holidays.UK(years=y),
        "HKD": lambda y: holidays.HK(years=y),
        "HUF": lambda y: holidays.CN(years=y), # TODO
        "IDR": lambda y: holidays.ID(years=y),
        "ILS": lambda y: holidays.CN(years=y), # TODO
